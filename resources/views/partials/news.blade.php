<div id="news">
    <h1 class="text-drey lg:text-4xl text-4xl text-center font-bold my-10">Trends For You</h1>
    <div class="container lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 gap-6 mx-auto px-2">
