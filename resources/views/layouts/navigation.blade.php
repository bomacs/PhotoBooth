<nav x-data="{ open: false }" class="bg-dgrey pb-1">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:p-2">
        <div class="flex justify-between items-center h-12">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden z-10 sm:flex sm:items-center md:inline block sm:ml-6">
                @if (Route::has('login'))
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden bg-red-100 sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('create_book')" :active="request()->routeIs('create_book')">
                {{ __('Book Now') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="#help">
                {{ __('Help') }}
            </x-responsive-nav-link>
        </div>
            @if (Route::has('login'))
